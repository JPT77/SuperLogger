...
public final class SimpleLog {
   ...
   private LogLevel defaultLevel = LogLevel.L4_INFO;
   ...
   readSettingsFromProperties()
   {
      ...
      if (defaultLevelStr != null)
      {
         ...
         try
         {
            ...
            defaultLevel = LogLevel.fromInt(level);
         }
         catch (NumberFormatException e1)
         {
            ...
            try
            {
               defaultLevel = LogLevel.fromName(defaultLevelStr);
            }
    ...
    */
   private void
   configure(AbstractLogger logger)
   {
    ...
    */
   private LogLevel
   getDebugLevel(AbstractLogger logger)
   {
      if (properties == null)
      {
         return defaultLevel;
      ...
      do
      {
         ...
         if (value != null)
         {
            ...
            try
            {
               ...
               debugLevel = LogLevel.fromInt(level);
            }
            catch (NumberFormatException e1)
            {
               ...
               try
               {
                  debugLevel = LogLevel.fromName(value);
               }
               catch (IllegalArgumentException e2)
               {
    ...
    */
   private boolean
   getTracingFlag(AbstractLogger logger)
   {
      if (properties == null)
      {
    ...
    */
   void
   register(AbstractLogger logger)
   {
    ...
    */
   public void
   setDefaultLevel(LogLevel defaultLevel)
   {
   ...
   extends Format
   {
      ...
      format(Object obj, StringBuffer buf, FieldPosition pos)
      {
         ...
         {
            throw new IllegalArgumentException(getClass().getName() + " only formats Throwables, not "+obj.getClass().getName());
         }
   ...
   extends Format
   {
      ...
      format(Object obj, StringBuffer buf, FieldPosition pos)
      {
         ...
         {
            throw new IllegalArgumentException(getClass().getName() + " only formats Object-Arrays, not "+obj.getClass().getName());
         }
